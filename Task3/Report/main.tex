...
\begin{document}
    ...
    \label{results} {
        ...
        \subsection{Naiwny klasyfikator Bayesa}
        Na początku wśród dostępnych wariantów została wybrana metoda, która najlepiej
        poradzi sobie z dostarczonymi zbiorami danych. Do eksperymentu został przyjęty
        podział 70\% danych uczących i 30\% testowych.
        ...
        \label{bayes_results} {
            \begin{table}[H]
                ...
                \hline
                \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}wariant\\ klasyfikatora\end{tabular}}} & \multicolumn{3}{c|}{\textbf{Zbiór danych}} \\ \cline{2-4} 
